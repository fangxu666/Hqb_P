...
public class MobileMessageUtil {
    ...
    public static SendSmsResponse sendSms(String telephone, String codeType) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", ConstantUtil.SEND_MOBILEINFO_ACCESSKEYID, ConstantUtil.SEND_MOBILEINFO_ACCESSKEYSECRET);
        DefaultProfile.addEndpoint("cn-hangzhou", "cn-hangzhou", ConstantUtil.SEND_MOBILEINFO_PRODUCT, ConstantUtil.SEND_MOBILEINFO_DOMAIN);
